...
const analysis1 = analyzeDescription(input1);

console.log(`- Title: "${analysis1.title}"`);
console.log(`- Category: "${analysis1.category}" (Expected: "Road Damage")`);
console.log(`- Location: "${analysis1.location}" (Expected: "Rajiv Chowk Metro Gate 3")`);
console.log(`- Severity: "${analysis1.severity}" (Expected: "High")`);
console.log(`- Department: "${analysis1.department}" (Expected: "PWD")`);

if (analysis1.category === "Road Damage" && 
    analysis1.location === "Rajiv Chowk Metro Gate 3" && 
    analysis1.severity === "High" &&
    analysis1.department.includes("PWD")) {
  console.log(green("✔ Test 1 PASSED!\n"));
} else {
  console.error(red("✘ Test 1 FAILED!\n"));
}
...
const analysis2 = analyzeDescription(input2);

console.log(`- Title: "${analysis2.title}"`);
console.log(`- Category: "${analysis2.category}" (Expected: "Electricity")`);
console.log(`- Severity: "${analysis2.severity}" (Expected: "Critical")`);
console.log(`- Department: "${analysis2.department}" (Expected: "DTL / DISCOM")`);

if (analysis2.category === "Electricity" && analysis2.severity === "Critical") {
  console.log(green("✔ Test 2 PASSED!\n"));
} else {
  console.error(red("✘ Test 2 FAILED!\n"));
}
...
if (duplicateMatch) {
  ...
  console.log(`- Match Text Similarity: ${Math.round(duplicateMatch.similarity * 100)}%`);
  console.log(green("✔ Test 3 PASSED!\n"));
} else {
  console.error(red("✘ Test 3 FAILED! No duplicate detected.\n"));
}
